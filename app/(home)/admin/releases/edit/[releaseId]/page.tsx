      ...
      <div className="relative">
        ...
        <Card className="glass-card border-white/10 bg-black/40 shadow-2xl overflow-hidden backdrop-blur-xl">
          <CardHeader className="border-b border-white/5 bg-white/5">
            ...
            <CardDescription className="text-muted-foreground/80">Update the details for this release.</CardDescription>
          </CardHeader>
          <CardContent className="p-6 md:p-8">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="flex gap-4 pt-4 border-t border-white/5 mt-8">
                ...
                <Button type="submit" disabled={updateReleaseMutation.isPending} className="flex-1 shadow-lg shadow-primary/20 bg-primary text-primary-foreground hover:bg-primary/90">
